        ...
        <div>
            <div className="md:flex gap-10 md:px-16 px-5 w-full mt-32 mb-10">
                ...
                <main className="w-full">
                    <div>
                        <h1 className="font-semibold md:text-xl text-lg mb-5 mt-5 md:mb-0">Update Password</h1>
                        <section className="bg-white p-6 w-full shadow rounded mt-5">
                            <form onSubmit={handleSubmit}>
                                ...
                                {errors.apiError && (
                                    <p className="mt-4 text-sm text-red-600">{errors.apiError}</p>
                                )}

                                <div className="mt-6 flex items-center justify-end gap-x-6">
                                    <Link href={ROUTES.Dashboard} className="text-sm font-semibold text-gray-900">
                                        Cancel
                                    </Link>
                                    <button
                                        type="submit"
