...
import HeroImage from '../public/img/about-hero.jpg'
import IntroImage from '../public/img/about-intro.jpg'
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 md:pt-40">
          ...
          <div className="max-w-3xl mx-auto text-center pb-16">
            <h1 className="h1 font-playfair-display text-slate-100">We are changing how legacies are continued</h1>
          </div>
