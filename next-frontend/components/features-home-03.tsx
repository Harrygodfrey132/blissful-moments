...
import FeaturesImage01 from '../public/img/QR-code-box.jpg'
import FeaturesImage02 from '../public/img/Profile-Screenshot.png'
import FeaturesImage03 from '../public/img/father-and-daughter.png'
...
export default function FeaturesHome03() {
  return (
    <section className="relative">
      ...
      {/* Dark background */}
      <div className="absolute inset-0 bg-gray-200 pointer-events-none -z-10 [clip-path:polygon(0_0,_5760px_0,_5760px_calc(100%_-_352px),_0_100%)] h-96 md:h-auto md:mb-64" aria-hidden="true"></div>
