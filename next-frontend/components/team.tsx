...
import TeamImage01 from '../public/img/team-01.jpg'
import TeamImage02 from '../public/img/team-02.jpg'
import TeamImage03 from '../public/img/team-03.jpg'
  ...
  return (
    <section className="bg-slate-100">
      ...
      <div className="mb-8 md:mb-16 overflow-hidden">
        <div className="mx-auto flex items-center space-x-2 md:space-x-4">
