          ...
          <div className="flex items-center gap-2">
            <div className="relative inline-block w-12 font-playfair align-middle select-none transition-all duration-200 ease-in">
              ...
              <label
                ...
                className={`toggle-label block overflow-hidden h-6 !w-12 rounded-full cursor-pointer transition-all duration-200 ease-in-out ${isObituaryEnabled ? "bg-blue-light-900" : "bg-gray-300"
                  }`}
              ></label>
            </div>
