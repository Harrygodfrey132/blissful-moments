<header class="flex items-center h-20 px-6 sm:px-10 bg-white">
  ...
  <div class="items-center hidden space-x-3 md:flex">
    ...
    <button class="relative inline-flex items-center p-2  rounded"
    ...
    <div class="absolute right-0 z-50 top-20 bg-white border rounded-md p-2 md:w-56" x-show="panel" style="display:none">
    ...
    <span class="h-10 w-10 bg-gray-100 rounded overflow-hidden">
      ...
      <div class="p-2 py-2 hover:bg-blue-100 cursor-pointer text-sm flex gap-2 items-center border-b"> Change Password</div>
      <div class="p-2 py-4 hover:bg-blue-100 text flex gap-2 text-sm cursor-pointer items-center"> Logout</div>
    </div>
