<aside x-data="{ menu: false }" 
    ...
    <div class="flex items-center justify-between h-16 px-4 pl-[26px] bg-[#575757]">
        <button @click="menu = !menu" class="text-white focus:outline-none">
            <svg style="width:25px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <nav class="flex-grow flex flex-col px-4 justify-between bg-[#575757] overflow-y-auto">
        <div class="flex flex-col mt-8 space-y-4">
            ...
            <a href="{{ route('configuration.index') }}"
                ...
                <span x-show="!menu && tooltip" class="absolute top-[-30px] left-1/2 transform -translate-x-1/2 bg-black text-white text-xs py-1 px-2 rounded shadow-lg">
                    Configurations
                </span>
            </a>
