    ...
    <div class="flex-grow flex flex-col justify-between bg-gray-950">
        <nav class="flex flex-col mx-4 my-6 space-y-4">
            ...
            <div class="relative">
                <!-- Trigger Button -->
                <a href="#"
                    class="inline-flex items-center w-full text-white py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-black focus:bg-white rounded-lg px-2 justify-start {{ request()->is('configuration*') ? 'text-black bg-white' : 'text-white hover:bg-gray-700' }}"
                    :class="{ 'justify-start': menu, 'justify-center': menu == false }"
                    ...
                    <!-- Dynamic Arrow -->
                    <svg x-show="!dropdown" xmlns="http://www.w3.org/2000/svg" class="ml-auto w-5 h-5"
                    ...
                    <svg x-show="dropdown" xmlns="http://www.w3.org/2000/svg" class="ml-auto w-5 h-5"
                        fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                            d="M14.707 10.293a1 1 0 010 1.414L10 16.414l-4.707-4.707a1 1 0 011.414-1.414L10 14.586l3.293-3.293a1 1 0 011.414 0z"
                            clip-rule="evenodd" />
                    </svg>
                </a>
                ...
                <div x-show="dropdown" @click.away="dropdown = false"
                    ...
                    class="absolute left-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-lg z-10" x-cloak>
                    <ul class="py-2">
                        <li>
