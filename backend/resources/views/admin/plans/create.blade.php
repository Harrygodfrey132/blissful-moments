<div>
    ...
    <form class="space-y-4" action="{{ route('plans.store') }}" method="POST">
        @csrf
        <div class="relative">
        ...
        <div class="relative mt-2">
            ...
            <textarea name="description" class="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset pl-4 focus:ring-indigo-600 sm:text-sm/6 block mt-1 w-full" id="" rows="3"></textarea>
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>
        <div>
